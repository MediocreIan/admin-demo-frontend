    ...
    useEffect(() => {
        ...
        if (!pricebook) {
                ...
                .then(result => {
                    ...
                    if (ApiPricebook) {
                        ...
                        if (window.configurator) {
                            let currentPrice = window.configurator.getPrice(ApiPricebook.id, ApiPricebook.currencies[0])
            ...
            if (window.configurator) {
                ...
                let currentPrice = window.configurator.getPrice(pricebook[0].id, pricebook[0].currencies[0])
                if (currentPrice !== price) {
                    setPrice(currentPrice)
                }
            }
